...
Read the file: 1. Start with a dataframe containing all file names
...
1.  Make a spaghetti plot showing observations on each subject over time, and comment on differences between groups.
...
1.  summarize within cities to obtain the total number of homicides and the number of unsolved homicides
...
1.  calculate the proportion for each city
